...
//std::vector:
//Преимущества:
	//1.Быстрый доступ к элементам : При использовании std::vector можно легко получить доступ к элементам по индексу, так как они хранятся в памяти последовательно.
	...
	//3.Динамическое изменение размера:  можно добавлять и удалять элементы из std::vector сравнительно легко.
...
//Преимущества:
	...
	//Поэтому, если  нужен быстрый доступ к элементам по индексу и вы часто изменяете размер контейнера, std::vector может быть более подходящим выбором.
	//С другой стороны, если необходимо часто вставлять или удалять элементы из середины контейнера, то std::list может быть более эффективным вариантом.
